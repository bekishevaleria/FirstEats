...
import com.example.firsteats.dummy.RestaurantContent;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(ItemDetailFragment.ARG_ITEM_ID, String.valueOf(RestaurantContent.ITEMS.indexOf(item)));
                    ...
                    intent.putExtra(ItemDetailFragment.ARG_ITEM_ID, String.valueOf(RestaurantContent.ITEMS.indexOf(item)));
